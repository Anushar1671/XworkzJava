...
<nav class="navbar" style="background-color: black; color:white">
		...
		<button type="submit" ><a href="Product.jsp">Product Information</a></button>
		
	</nav>
	<h1>Product Description.</h1>
	<h5>Product Saved Successfully.</h5>
	...
	<h5 style="color: red">Total : ${info.price * info.quantity}</h5>
